                            ...
                            <div class="dropdown-menu rounded-5" id="filterMenu" style="padding: 15px; min-width: 320px;">
                                ...
                                <div class="mb-2">
                                    <div class="input-wrapper has-icon">
                                        <input type="text" class="form-control custom-radius" id="factor_date"
                                            name="factor_date" data-jdp value="{{ request()->get('factor_date') }}"
                                ...
                                <div class="mb-2">
                                    <div class="input-wrapper has-icon">
                                        <input type="text" class="form-control custom-radius" id="created_at"
                                            name="created_at" data-jdp placeholder="انتخاب تاریخ صدور فاکتور"
                                ...
                                <div class="mb-2">
                                    <div class="input-wrapper has-icon">
                                        <input type="text" class="form-control custom-radius" id="payed_factor_data"
                                            name="payed_factor_data" data-jdp placeholder="انتخاب تاریخ پرداخت فاکتور">
                                        <div class="icon-box"
                                            onclick="document.getElementById('payed_factor_data').focus()">
                                            <i class="fa fa-calendar"></i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-2">
                                    <select name="price_status" class="form-control custom-radius custom-select-input">
                                        ...
                                        <option value="0"
                                            {{ request()->get('price_status') == '0' ? 'selected' : '' }}>در حال پرداخت
                                        </option>
                                        <option value="1"
                                            {{ request()->get('price_status') == '1' ? 'selected' : '' }}>پرداخت نشده
                                        </option>
                                        <option value="2"
                                            {{ request()->get('price_status') == '2' ? 'selected' : '' }}>پرداخت شده
                                        </option>
                                        <option value="3"
                                            {{ request()->get('price_status') == '3' ? 'selected' : '' }}>کارت به کارت
                                        </option>
                                        <option value="4"
                                            {{ request()->get('price_status') == '4' ? 'selected' : '' }}>معلق شده</option>
                                    </select>
                                </div>
                                    ...
                                    <select class="form-control custom-radius select2" name="store_id">
                                        ...
                                        @foreach ($stores as $store)
                                            <option value="{{ $store->id }}"
                                                {{ request()->get('store_id') == $store->id ? 'selected' : '' }}>
                                                {{ $store->store_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="d-flex justify-content-between mt-3">
                                    <p type="button" id="clearFiltersBtn" class="mt-3 text-default text-bold"
                                        style="display: flex">حذف فیلترها</p>

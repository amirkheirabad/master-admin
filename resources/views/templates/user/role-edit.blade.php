...
@section('js')
    ...
    <script src="{{ asset('/js/edit-role.js') }}"></script>
    <script>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="">
                ...
                <form id="editRoleForm" method="post" action="" class="x_panel rounded-4">
                    @csrf
                    ...
                    <div class="form-group mt-8">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12 mb-3">
                                <label>نام نقش</label>
                                <input type="text" value="{{ $role->name }}" name="name" id="name" class="form-control custom-radius input-border-focus">
                                <div class="mt-1">
                            ...
                            <div class="col-md-6 col-xs-12 mb-3">
                                ...
                                <select id="permission" class="form-control custom-radius select2 input-border-focus" multiple>
                                    @foreach($permissions as $permission)
                                        <option value="{{$permission->name}}" {{ $role->hasPermissionTo($permission->name) ? 'selected' : '' }}>{{ __($permission->name) }}</option>
                                    @endforeach
                                </select>
                                <div class="mt-1">

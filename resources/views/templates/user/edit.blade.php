                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12 mb-3">
                                ...
                                <select name="type" id="type" class="form-control custom-radius custom-select-input input-border-focus" style="background: #f9fafb;">
                                    <option value="0" {{ $user->type === 0 ? 'selected' : '' }}>عادی</option>
                                    <option value="1" {{ $user->type === 1 ? 'selected' : '' }}>تیم فنی</option>
                                </select>
                                <div class="mt-1">
                            ...
                            <div class="col-md-6 col-xs-12 mb-3">
                                <label class="fw-bold">تیم عملیاتی</label>
                                <select name="team_id" id="team_id" class="form-control custom-radius custom-select-input input-border-focus" style="background: #f9fafb;">
                                ...
                                <div class="mt-1">
                                    <span class="text-danger error-message" id="team_id_error"></span>
                                </div>
                            </div>

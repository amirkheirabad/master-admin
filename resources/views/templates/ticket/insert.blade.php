            ...
            <div class="">
                ...
                <form id="ticketFormUser" method="post" action="" class="x_panel rounded-4">
                    ...
                    <div class="ticket-reply">
                        ...
                        <ul>
                            <li>حداکثر تا ۲۴ ساعت بعد از ارسال تیکت، پاسخ آن برای شما ارسال خواهد شد.</li>
                            <li>زمان پاسخ‌دهی به تیکت‌هایی که نیاز به بررسی یا پیگیری بیشتری دارند، کمی طولانی‌تر خواهد بود.</li>
                            <li>تمام تیکت‌های ارسالی، توسط کارشناسان واحد امور مشتریان بررسی و پاسخ‌دهی می‌شوند، بنابراین جهت پیگیری وضعیت تیکت نیازی به برقراری تماس تلفنی نیست.</li>
                            <li>پس از دریافت پاسخ پشتیبان، در صورتی که تا ۷۲ ساعت پاسخ جدیدی از سمت شما ارسال نشود، تیکت به‌صورت خودکار بسته خواهد شد و امکان ارسال پاسخ وجود نخواهد داشت.</li>
                        </ul>

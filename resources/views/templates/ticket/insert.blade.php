            ...
            <div class="">
                ...
                <form id="ticketFormUser" method="post" action="" class="x_panel rounded-4">
                    ...
                    <div class="ticket-reply">
                        ...
                        <ul>
                            <li>درخواست شما پس از ثبت، توسط تیم پشتیبانی Index بررسی و در کوتاه‌ترین زمان ممکن پاسخ داده خواهد شد.</li>
                            <li>زمان پاسخ‌گویی معمولاً حداکثر ۲۴ ساعت کاری است؛ درخواست‌های دارای اولویت با سرعت بیشتری پیگیری می‌شوند.</li>
                            <li>برای حفظ سوابق و افزایش کیفیت خدمات، تمامی ارتباطات و پیگیری‌ها از طریق سیستم تیکتینگ انجام می‌شود.</li>
                            <li>در صورت نیاز به اطلاعات تکمیلی، کارشناسان ما از طریق همین تیکت با شما در ارتباط خواهند بود.</li>
                        </ul>

...
class DashboardRepo implements InterfaceDashboard
{
    public function getData(): array
    {
        ...
        if ($isAdmin) {
            ...
            $recentTickets = Ticket::with('store')->orderByDesc('created_at')->limit(5)->get();
        ...
        return [
            ...
            'todayFormatted' => Verta::now()->format('%A %d %B %Y'),
            'ticketStatusLabels' => [
